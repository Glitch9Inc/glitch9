// Ported verbatim from the WordPress export at docs/source-site/.
// Text is NOT edited — only re-structured for rendering.
...
export default {
  ...
  },
  {
    ...
    "title": "제1조 (목적)",
    "blocks": [
      "이 약관은 Munchkin Productions(이하 “회사”라 합니다)가 모바일 기기를 통해 제공하는 게임 서비스 및 이에 부수하는 네트워크, 웹사이트, 기타 서비스(이하 “서비스”라 합니다)의 이용에 대한 회사와 서비스 이용자의 권리ㆍ의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다."
    ],
    "level": 2
  },
  {
  ...
  },
  {
    ...
    "blocks": [
      "① 회사는 이 약관의 내용을 회원이 알 수 있도록 게임서비스 내 또는 그 연결화면에 게시합니다. 이 경우 이 약관의 내용 중 서비스 중단, 청약철회, 환급, 계약 해제․해지, 회사의 면책사항 등과 같은 중요한 내용은 굵은 글씨, 색채, 부호 등으로 명확하게 표시하거나 별도의 연결화면 등을 통하여 회원이 알아보기 쉽게 처리합니다.",
  ...
  },
  {
    ...
    "title": "제12조 (서비스의 이용)",
    "blocks": [
      "① 게임서비스는 회사의 영업방침에 따라 정해진 시간 동안 제공합니다. 회사는 게임서비스 제공시간을 게임 애플리케이션 초기화면이나 게임서비스 공지사항에 적절한 방법으로 안내합니다.",
  ...
  },
  {
    ...
    "title": "제15조 (광고의 제공)",
    "blocks": [
      "① 회사는 서비스의 운영과 관련하여 게임서비스 내에 광고를 게재할 수 있습니다. 또한 수신에 동의한 회원에 한하여 전자우편, 문자서비스(LMS/SMS), 푸시메시지(Push Notification) 등의 방법으로 광고성 정보를 전송할 수 있습니다. 이 경우 회원은 언제든지 수신을 거절할 수 있으며, 회사는 회원의 수신 거절 시 광고성 정보를 발송하지 아니합니다.",
  ...
  {
    "id": "article-19",
    "title": "제16조 (저작권 등의 귀속)",
    "blocks": [
      "① 회사가 제작한 게임서비스 내의 콘텐츠에 대한 저작권과 기타 지적재산권은 회사에 귀속합니다.",
  ...
  {
    "id": "article-20",
    "title": "제17조 (유료 콘텐츠의 구매, 사용기간 및 이용)",
    "blocks": [
  ...
  {
    "id": "article-23",
    "title": "제20조 (이용제한 조치에 대한 이의신청 절차)",
    "blocks": [
  ...
  {
    "id": "chapter-5",
    "title": "제5장 청약철회, 과오납금의 환급 및 이용계약의 해지",
    "blocks": [],
    "level": 1
  },
  {
  ...
  },
  {
    ...
    "title": "제24조 (계약 해지 등)",
    "blocks": [
      "① 회원은 언제든지 서비스 이용을 원하지 않는 경우 회원 탈퇴를 통해 이용계약을 해지할 수 있습니다. 회원탈퇴로 인해 회원이 게임서비스 내에서 보유한 게임이용정보는 모두 삭제되어 복구가 불가능하게 됩니다.",
  ...
  {
    "id": "article-32",
    "title": "제27조 (회원에 대한 통지)",
    "blocks": [
      "① 회사가 회원에게 통지를 하는 경우 회원의 전자우편주소, 전자메모, 게임 서비스 내 쪽지, 문자메시지(LMS/SMS) 등으로 할 수 있습니다.",
